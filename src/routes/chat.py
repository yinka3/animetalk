...
from src.models.chat import Chats, ChatMembers
from src.schemas.chat import CreateChat, ChatResponse, ChatMemberResponse, AddChatMember
...
class ConnectionManager:
    ...
    async def broadcast(self, chat: Chats, message: dict):
...
async def websocket_endpoint(websocket: WebSocket, chat: Chats, db: Session = Depends(get_db())):
    ...
    try:
        while True:
            ...
            await connection_manager.broadcast(chat, data)
